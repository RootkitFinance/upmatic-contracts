...
const UniswapPairJson = require('../contracts/json/UniswapV2Pair.json');
const UniswapFactoryJson = require('../contracts/json/UniswapV2Factory.json');
...
exports.createUniswap = async function(owner) {
    ...
    const factory = await new ethers.ContractFactory(UniswapFactoryJson.abi, UniswapFactoryJson.bytecode, owner).deploy(owner.address);
    ...
    return {
        ...
        library,
        weth,
        pairFor: address => new ethers.Contract(address, UniswapPairJson.abi, owner)
    };
}